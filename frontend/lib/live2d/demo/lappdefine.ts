...
// MotionSync モデル定義 (advanced lip sync support)
export const MotionSyncModelDir: string[] = [
  'Kei_basic',
  'Kei_vowels'
];
export const MotionSyncModelDirSize: number = MotionSyncModelDir.length;

// MotionSync リソースパス
export const MotionSyncResourcesPath = '/live2d/motionsync-models/';
