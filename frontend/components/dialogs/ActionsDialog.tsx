...
export interface ActionsDialogProps {
    ...
    setQuickToggleOriginalVoiceoverId: (id: string | null) => void;
    quickToggleTranslatedVoiceoverId: string | null;
    setQuickToggleTranslatedVoiceoverId: (id: string | null) => void;
    // Timeline
...
export function ActionsDialog({
    ...
    setQuickToggleOriginalVoiceoverId,
    quickToggleTranslatedVoiceoverId,
    setQuickToggleTranslatedVoiceoverId,
    timelineLoading,
    hasTimeline,
                                            ...
                                            >
                                                ...
                                                <div className="space-y-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <label className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Quick Toggle Presets</label>
                                                    </div>
                                                    <p className="text-xs text-gray-400 dark:text-gray-500">
                                                        Set up two audio tracks for quick switching with the toggle button on the video player.
                                                    </p>
                                                    ...
                                                    {quickToggleTranslatedVoiceoverId && (
                                                        <p className="text-xs text-green-600 dark:text-green-400 flex items-center gap-1">
                                                            ...
                                                            Quick toggle ready! Use the <ArrowLeftRight className="w-3 h-3 inline mx-0.5" /> button on video.
                                                        </p>
                                                    )}
                                                </div>
                                            </div>
