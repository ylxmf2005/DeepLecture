                    ...
                    <div className="flex-1 min-h-0">
                        {subtitlesLoading && sidebarSubtitles.length === 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center h-full text-gray-500 gap-4 p-8 text-center">
                                ...
                                {sidebarSubtitleMode === "source" ? (
                                    <>
                                        <p>No subtitles available for current language settings.</p>
                                        <button
                                            type="button"
                                            onClick={onGenerateSubtitles}
                                            disabled={processing}
                                    ...
                                    <p>
                                        {sidebarSubtitleMode === "target"
                                            ...
                                            : "Bilingual subtitles not available."}
                                        {" "}Generate translation in the Actions tab, or switch to Source view.
                                    </p>
                                )}
                            </div>
                        )}
