...
class NoteUseCase:
    ...
    def _load_context(
        ...
        # For video content, subtitles are required
        if content_type == "video" and not has_subtitle:
            raise ValueError("Cannot generate notes: this video has no subtitles yet. Please generate subtitles first.")
