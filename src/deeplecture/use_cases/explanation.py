...
from deeplecture.use_cases.shared.prompt_safety import normalize_llm_markdown, sanitize_learner_profile
...
class ExplanationUseCase:
    ...
    def generate(self, request: GenerateExplanationRequest) -> ExplanationResult:
        ...
        explanation_text = normalize_llm_markdown(explanation_text)
